...
- Game "Primeria" (monster-tamer RPG): `artifacts/mockup-sandbox/src/components/mockups/walk-demo/`
  ...
  - `WalkDemo.tsx` — overworld engine (scenes: overworld/home/lab/route1/route2/area3/maya/jay/ellio/lia, movement, doors, NPCs, quests, inventory UI).
    ...
    - **Door positions** (all moved to user-tapped spots via the DEV door tool; rect = `[x1,y1,x2,y2]`, label shows top-left): Player home `[544,735,604,765]` + up-key; Lia `[945,738,1005,768]`; Ellio `[174,709,234,769]` + up-key (exit returns to `(204,790)`); Jay `[195,349,263,397]`; Maya `[965,335,1030,397]`. Lab `[533,325,615,382]` unchanged.
