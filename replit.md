...
- Game "Primeria" (monster-tamer RPG): `artifacts/mockup-sandbox/src/components/mockups/walk-demo/`
  ...
  - `WalkDemo.tsx` — overworld engine (scenes: overworld/home/lab/route1/route2/area3/maya/jay/ellio/lia, movement, doors, NPCs, quests, inventory UI).
    ...
    - **Door positions**: Player home `[545,820,605,850]` + up-key; Lia `[890,780,950,810]`; Ellio `[238,698,298,758]` + up-key (front-yard frontage/mailbox area where the player naturally stands, S of the house; Ellio building body shrunk to y=700 so the front yard is walkable. Door is intentionally E of the visible arched door per user feedback — they enter from where they stand on the path); Jay `[240,400,308,448]`; Maya `[895,383,960,445]`.
