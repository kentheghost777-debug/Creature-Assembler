...
- Game "Primeria" (monster-tamer RPG): `artifacts/mockup-sandbox/src/components/mockups/walk-demo/`
  ...
  - `WalkDemo.tsx` — overworld engine (scenes: overworld/home/lab/route1/route2/area3/maya/jay/ellio/lia, movement, doors, NPCs, quests, inventory UI).
    ...
    - **Door positions**: Player home `[545,820,605,850]` + up-key; Lia `[890,780,950,810]`; Ellio `[196,700,250,740]` + up-key (sits on the visible arched door; Ellio building body shrunk to y=700 + west fence to y=700 so the front yard/door is reachable); Jay `[240,400,308,448]`; Maya `[895,383,960,445]`.
