...
const TR_CRYSTALFANG: MonSpec = { id:"tr_crystalfang", name:"Crystalfang", type:"Frostformed", rarity:"apex", wildImg:"/__mockup/images/crystalfang.png", playerImg:"/__mockup/images/crystalfang.png", wildFaces:"right", playerFaces:"right", maxHp:78, baseDmg:[9,16] };
...
export function WalkDemo({ characterId = "kinju", roleId: roleIdProp = "keeper" }: { characterId?: CharId; roleId?: RoleId } = {}) {
  ...
  const heroSideImg = `/__mockup/images/${CHAR_IMG_KEY[characterId]}_hero.png`;
        ...
        <div ref={worldRef} style={{
          ...
          <img
            ...
            src={scene === "ellio" ? "/__mockup/images/ellio-home-interior.png"
              ...
              : scene === "area4"  ? "/__mockup/images/area3-bg.png"
