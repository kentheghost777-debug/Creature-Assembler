...
export function WalkDemo({ characterId = "kinju", roleId: roleIdProp = "keeper" }: { characterId?: CharId; roleId?: RoleId } = {}) {
  ...
  const LINES: Record<Phase, string> = {
    ...
    jay_a3_idle: "I've been cataloguing the Tayanari in these ruins — type distributions, territorial overlap, behavioral patterns that don't match anything in the field guides. Someone needs to write the new chapter on this place. Might as well start now. How's your team holding up in here?",
