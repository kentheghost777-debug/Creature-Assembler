...
const EVO_TABLE: Array<{ from: string; atLevel: number; to: StarterSpec }> = [
  ...
  { from:"gloamite",   atLevel:22, to:{ id:"umbravel",     name:"Umbravel",     type:"Abyss",       color:"#5020a0", img:"/__mockup/images/spectrael-wild.png"  } },
  ...
  { from:"sunpetal",   atLevel:18, to:{ id:"solmane",      name:"Solmane",      type:"Radiant",     color:"#f5d860", img:"/__mockup/images/spectrael-wild.png"  } },
