...
const WYVCHAOS_SPEC:  MonSpec = { ...WYVRUNT_SPEC, id:"aureyvant_chaos", name:"VoidDrake",   nameIcon:"☯", wildImg:"/__mockup/images/aureyvant.png", playerImg:"/__mockup/images/aureyvant.png", maxHp:120, baseDmg:[17,28] };
