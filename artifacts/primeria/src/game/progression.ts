...
export type PrismStoneItem = {
  id: PrismStoneId;
  name: string;
  color: string;      // display / pill color
  /** CSS hue-rotate degrees applied to the mon sprite */
  hue: number;
  /** CSS saturate multiplier (1 = unchanged, 2 = 200%) */
  sat: number;
  /** CSS brightness multiplier */
  bri: number;
  ...
  /** 0–1 drop chance from any wild battle (0 = no drop) */
  dropChance: number;
};
...
/** CSS filter string for a prism stone applied to a mon sprite. */
