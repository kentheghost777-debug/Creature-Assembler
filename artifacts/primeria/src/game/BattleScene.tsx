...
export function BattleScene({
  ...
  // glitter burst active for 1.6s on entry
      ...
      <div style={{
        ...
        <div style={standOn(POS.mon, formWidthPct(active.id, 24), 3, formAnchor(active.id, 80))}>
          <div style={{
            ...
            {/* Prism shimmer — persistent sparkle layer while stone is slotted */}
            {prismStone && (
              <div aria-hidden style={{
                position:"absolute", inset:0, pointerEvents:"none", overflow:"hidden",
                borderRadius:4,
              }}>
                {/* Persistent shimmer overlay */}
                <div style={{
                  position:"absolute", inset:0,
