...
const WYRNAK_SPEC:    MonSpec = { ...WYVRUNT_SPEC, id:"wyrnak",    name:"Wyvrunt II",    nameIcon:"☯", wildImg:"./images/wyrnak.png",    playerImg:"./images/wyrnak.png",    maxHp:80,  baseDmg:[11,18] };
const WYRVAST_SPEC:   MonSpec = { ...WYVRUNT_SPEC, id:"wyrvast",   name:"Wyvrunt III",   nameIcon:"☯", wildImg:"./images/wyrvast.png",   playerImg:"./images/wyrvast.png",   maxHp:100, baseDmg:[13,22] };
const AUREYVANT_SPEC: MonSpec = { ...WYVRUNT_SPEC, id:"aureyvant", name:"Wyvrunt IV", nameIcon:"✦", wildImg:"./images/aureyvant.png", playerImg:"./images/aureyvant.png", maxHp:120, baseDmg:[16,26] };
